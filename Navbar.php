      ...
      // Echo the anchor element
       ...
       <!-- <div style="margin: 0 auto;" class="flex flex-nowrap  items-center ">
        <div class="content flex flex-col">
                <h1 class="text-xl text-bold">Welcome to Sign Language Recognition System</h1>
                <div class="mt-4">
                    <button class="mt-2 rounded-xl font-bold bg-blue-400 p-2">Convert Text to Sign</button>
                    <button class="mt-2 rounded-xl font-bold bg-blue-400 p-2">Convert Sign to Text</button>
                </div>
            </div>
            <div>
